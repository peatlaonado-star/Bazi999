...
function buildElementRadar(p, r, l) {
  ...
  var elDescs  = isTH
    ? ['ผู้มีพลังริเริ่ม กล้าหาญ เป็นผู้นำโดยธรรมชาติ — แต่ต้องระวังโทสะที่เผาทั้งตัวเองและคนรอบข้าง', 
       'ผู้มีความมั่นคง รอบคอบ ไว้ใจได้ — แต่ต้องระวังการยึดติดและไม่ยอมปล่อยสิ่งที่ควรปล่อย', 
       'ผู้ที่มีความยืดหยุ่น สื่อสารเก่ง ปรับตัวไว — แต่ต้องระวังจิตฟุ้งกระจาย เริ่มไม่จบ', 
       'ผู้ที่มีความลึกซึ้ง อ่อนไหว สัญชาตญาณแม่น — แต่ต้องระวังการรับอารมณ์คนอื่นมาแบก']
  ...
  var remedyTxt = isTH 
    ? [
        '<span class="hl-gold">เหตุเสริมธาตุไฟ:</span> นั่งสมาธิ "พุท-โธ" 3 นาทีทุกเช้า — อานาปานสติช่วยสงบไฟในตัว พระพุทธเจ้าสอนว่า "ผู้ชนะในสงครามพันครั้ง สู้ชนะใจตัวเองไม่ได้" และให้น้ำดื่ม 1 ขวดกับคนทำงานกลางแดด — ทานน้ำ = ดับร้อนในใจ',
        '<span class="hl-gold">เหตุเสริมธาตุดิน:</span> เดินจงกรม 10 นาที รู้สึกเท้าแตะพื้น — กรรมฐาน 4 อิริยาบถ หลวงปู่ชาสอน "เดินก็รู้ว่าเดิน" ช่วยให้ดินยืดหยุ่นขึ้น และให้แรงกายช่วยคน 1 อย่าง — ทานแรงกาย = ใช้ร่างกายเป็นทาน',
        '<span class="hl-gold">เหตุเสริมธาตุลม:</span> นั่งนิ่ง 3 นาที ดูลมหายใจ — "พุท" เข้า "โธ" ออก จิตฟุ้งก็กลับมา ลมนิ่ง = จิตนิ่ง และให้ธรรมทาน: สอนความรู้ 1 เรื่องให้คนที่ต้องการ — ธรรมทานชนะทานทั้งปวง',
        '<span class="hl-gold">เหตุเสริมธาตุน้ำ:</span> แผ่เมตตาให้ตัวเอง "นิททุกโข โหมิ — ขอให้ข้าพเจ้าปราศจากทุกข์" 3 นาทีก่อนนอน — เมตตานิสังสสูตร: หลับสุข ตื่นสุข จิตตั้งมั่นเร็ว และงดนินทา 7 วัน — น้ำนิ่ง = ใจนิ่ง'
      ]
    : [
