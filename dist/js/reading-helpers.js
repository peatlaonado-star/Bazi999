...
function buildMonthlyLifeMap(p, r, l, birthDate, today){
  ...
  return {
    ...
    domains: (cfg.domains || FALLBACK_MONTHLY_LIFE_MAP.domains).map(function(domain, index){
      ...
      var domainForecasts = {
        career: [
          'เดือนนี้งานที่ค้างไว้จะส่งผลชัด เคลียร์ให้จบก่อนสิ้นเดือนแล้วจะเบาขึ้นมาก',
          'เลือกงานที่สร้างชื่อให้ตัวเองก่อน โอกาสมาจากจุดนี้',
          'ถ้ามีการคุยเรื่องบทบาท เดือนนี้เหมาะ — อย่าปล่อยผ่าน',
          'โปรเจกต์ที่เคยหยุดไปจะกลับมาให้เห็น รับไว้ก่อน'
        ],
        money: [
          'กันเงินสำรองไว้ก่อนใช้ แล้วที่เหลือจะจัดการง่ายขึ้น',
          'รายจ่ายที่ไม่จำเป็นจะโผล่มาให้เห็นชัด — ตัดได้ตัดเลย',
          'เดือนนี้เหมาะทบทวนเงินรั่ว ดูให้ดีจะเจอจุดที่ประหยัดได้',
          'ถ้ามีของใหญ่อยากซื้อ รอสัก 2 สัปดาห์ค่อยตัดสินใจ'
        ],
        windfall: [
          'ลาภลอยมาแบบสั้น ๆ ถ้าเจอเลขซ้ำให้ลองดูสักครั้ง',
          'โชคลอยมาจากที่ที่ไม่คาดคิด อย่ามองข้ามเรื่องเล็ก',
          'เลขที่เจอซ้ำรอบตัวเดือนนี้มีความหมาย — จดไว้บ้าง',
          'เสี่ยงเล็กพอสนุกได้ แต่อย่าไล่ทุนถ้าพลาด'
        ],
        relationship: [
          'พูดตรงแต่ใจเย็นเข้าไว้ เดือนนี้ถ้อยคำมีพลังเป็นพิเศษ',
          'นัดคุยกันก่อนคิดแทนกัน หลายเรื่องแค่ถามก็จบ',
          'ลดคาดหวังที่ไม่เคยบอกออกไป แล้วจะเบาขึ้น',
          'ถ้ามีเรื่องค้างคาใจ ปลายเดือนเหมาะจะเคลียร์'
        ],
        health: [
          'พักให้เป็นเวลาขึ้นอีกนิด ร่างกายจะตอบแทนชัด',
          'อย่าฝืนถ้ารู้สึกไม่ไหว — พักก่อนค่อยลุยต่อ',
          'ทำ routine เล็ก ๆ ทุกวัน ดีกว่าโหมหนักแค่วันเดียว',
          'เดือนนี้สายตาและหลังต้องดูแลเป็นพิเศษ'
        ]
      };
      var domainActions = {
        career: [
          'เลือกงานที่ค้างอยู่ 1 ชิ้น แล้วปิดให้จบใน 2 สัปดาห์นี้',
          'ส่งมอบงานให้ชัดเจน อย่าปล่อยให้ค้างคา',
          'เลื่อนเรื่องรองไว้ก่อน โฟกัสเรื่องหลักให้จบ',
          'คุยเรื่องบทบาทกับคนที่เกี่ยวข้องภายในเดือนนี้'
        ],
        money: [
          'ตั้งงบ 3 ช่อง: จำเป็น / อยากได้ / เก็บออม',
          'พักก่อนซื้อของใหญ่ รอให้ผ่าน 2 สัปดาห์ค่อยตัดสินใจ',
          'แยกเงินเสี่ยงออกจากเงินใช้จริงให้ชัดเจน',
          'จดรายจ่ายทุกวันเป็นเวลา 1 สัปดาห์ จะเห็นภาพชัด'
        ],
        windfall: [
          'ตั้งงบเสี่ยงไว้แล้วหยุดเมื่อถึง ไม่ไล่ทุน',
          'จดเลขที่เจอซ้ำรอบตัวไว้สัก 3 วัน',
          'ลองเสี่ยงเล็กพอสนุก อย่าทุ่มเกินตัว',
          'ดูเลขจากวันเกิดและวันสำคัญรอบตัวเดือนนี้'
        ],
        relationship: [
          'พูดความต้องการ 1 เรื่องที่ยังไม่เคยบอก',
          'ฟังก่อนตอบ นับ 1-3 ในใจก่อนพูด',
          'นัดคุยตอนใจนิ่ง อย่าคุยตอนหงุดหงิด',
          'ส่งข้อความหาคนที่คิดถึงสัก 1 คนวันนี้'
        ],
        health: [
          'นอนให้ตรงเวลา 7 วันติดกัน แล้วจะเห็นผล',
          'พักสายตาทุก 1 ชั่วโมง ถ้าทำงานหน้าจอ',
          'ทำ routine เล็ก ๆ 7 วันติดกัน เช่น เดิน 15 นาที',
          'ดื่มน้ำให้ครบ 8 แก้วทุกวันเป็นเวลา 1 สัปดาห์'
        ]
      };
      var omenPool = {
        career: [
          'ถ้ามีคนเก่าทักมา ให้รับไว้ — อาจมีโอกาสซ่อนอยู่',
          'ถ้าเห็นข้อความงานเด้งซ้ำ ๆ แปลว่าเรื่องนี้ต้องจัดการ',
          'ความรู้สึกอยากเปลี่ยนแปลงแรงขึ้น ให้ฟังเสียงข้างใน',
          'ถ้ามีคนชวนทำอะไรใหม่ ลองรับฟังก่อนตัดสินใจ'
        ],
        money: [
          'ถ้าเห็นแบงค์ 500 ซ้ำ ๆ แปลว่าเงินกำลังจะขยับ',
          'ถ้ามีคนคืนเงินหรือของที่ยืมไป แปลว่ากระแสเงินดี',
          'ความรู้สึกอยากจัดระเบียบเงินมาแรง ให้ลงมือเลย',
          'ถ้าเห็นราคาหรือตัวเลขซ้ำรอบตัว ให้จดไว้'
        ],
        windfall: [
          'ถ้าฝันเห็นตัวเลข ให้จดไว้ก่อนตื่น',
          'ถ้าเจอเหรียญหรือแบงค์ตก ให้เก็บไว้เป็นเคล็ด',
          'ความรู้สึกอยากเสี่ยงมาแรง ให้ลองเล็ก ๆ',
          'ถ้ามีคนทักเรื่องโชคโดยไม่ได้ถาม ให้ลองดู'
        ],
        relationship: [
          'ถ้ามีคนที่ไม่ได้คุยนานทักมา ให้ตอบกลับ',
          'ความรู้สึกอยากอยู่คนเดียวแรงขึ้น ก็ไม่ผิด',
          'ถ้าเห็นคู่รักแสดงความรักต่อหน้า แปลว่าความรักกำลังจะดี',
          'ถ้าทะเลาะกันเล็กน้อย ให้ถอยออกมาคิดก่อน'
        ],
        health: [
          'ถ้ารู้สึกเหนื่อยง่ายกว่าปกติ ให้พักจริงจัง',
          'ความรู้สึกอยากออกกำลังกายมาแรง ให้เริ่มเลย',
          'ถ้ามีอาการเตือนเล็ก ๆ อย่าเพิกเฉย',
          'ถ้านอนหลับดีขึ้นเอง แปลว่าร่างกายกำลังปรับตัว'
        ]
      };
