...
// วันพระ (Wan Phra) — Buddhist holy days based on Thai lunar calendar
...
function buildMonthlyLifeMap(p, r, l, birthDate, today){
  ...
  return {
    ...
    domains: (cfg.domains || FALLBACK_MONTHLY_LIFE_MAP.domains).map(function(domain, index){
      ...
      var domainActions = {
        career: [
          'นั่งสมาธิ "พุท-โธ" 3 นาทีก่อนเริ่มงานทุกวัน — สมาธิเพิ่มพลังงานและความชัดเจน',
          'ธรรมทาน: สอนความรู้ 1 เรื่องให้รุ่นน้อง/เพื่อนร่วมงาน — ธรรมทานชนะทานทั้งปวง',
          'ถือศีล 5 เต็มวัน + ไม่นินทาเพื่อนร่วมงาน — กรรมทางวาจาส่งผลต่อเส้นทางงาน',
          'แผ่เมตตาให้หัวหน้า/เพื่อนร่วมงานที่ขัดใจ 3 นาทีก่อนนอน — ลดเวร เปิดทางงาน'
        ],
        money: [
          ...
          'ถ้ามีของใหญ่อยากซื้อ รอ 7 วัน — ถือศีล 5 ครบ 7 วันก่อนค่อยตัดสินใจ',
          'แผ่เมตตาให้ตัวเอง: "ขอให้ข้าพเจ้ามีทรัพย์เพียงพอ" — 3 นาทีก่อนนอน'
        ],
        windfall: [
          'ทำบุญ 1 อย่างก่อนเสี่ยง — ทานเปิดทางลาภ (สัปปุริสทาน 8)',
          'ตั้งงบเสี่ยงไว้ล่วงหน้า เมื่อถึงให้หยุดทันที — ศีลข้อ 5 รักษาสติ',
          'วันพระถัดไป ' + (typeof getNextWanPhra === 'function' ? getNextWanPhra(new Date()).dateStr : 'เช็คปฏิทิน') + ' — ถือศีล 8 + ถวายสังฆทาน อานิสงส์ 100 เท่า',
          'ถ้าฝันเห็นตัวเลข ให้จดไว้ก่อนตื่น แล้วทำบุญ 1 อย่างก่อนเสี่ยง'
        ],
        relationship: [
          'แผ่เมตตาให้คนรัก 3 นาทีก่อนนอน: "สุขิตา โหนตุ — ขอให้เขามีความสุข"',
          'ฟังก่อนตอบ หยุด 1 ลมหายใจก่อนพูด — สตินำวาจา ลดกรรมทางวาจา',
          'ถ้าขัดใจกัน แผ่เมตตาให้คนนั้น 3 นาที — ลดเวร เปิดทางรัก',
          'ชม/ขอบคุณคนใกล้ตัว 1 คนอย่างจริงใจวันนี้ — เมตตาเริ่มจากคำพูดง่ายๆ'
        ],
        health: [
          'นั่งสมาธิ 5 นาทีก่อนนอน — อานาปานสติ "พุท-โธ" ช่วยให้หลับลึก',
          'เดินจงกรม 10 นาที — กรรมฐาน 4 อิริยาบถ หลวงปู่ชาสอน "เดินก็รู้ว่าเดิน"',
          'นอนก่อน 4 ทุ่ม 7 วันติด — วินัย = ศีล ดูแลกาย = ดูแลธรรม',
          'ถือศีล 5 เต็มวัน — ศีลคือรากฐานของสุขภาพทั้งกายและใจ'
        ]
      };
      var omenPool = {
        career: [
