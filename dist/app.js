...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-desc">ก่อนนอนคืนนี้ แผ่เมตตาให้คนรัก 3 นาที: <span class="cb-highlight">"สุขิตา โหนตุ — ขอให้เขามีความสุข"</span> — เมตตานิสังสสูตรสอนว่า เมื่อแผ่เมตตาสม่ำเสมอ ความรักจะราบรื่นขึ้นเอง และหยุด 1 ลมหายใจก่อนพูดทุกครั้ง — สตินำวาจา (ศีล 4)</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">นั่งสมาธิ <span class="cb-highlight">"พุท-โธ" 3 นาทีก่อนเริ่มงานทุกวัน</span> — สมาธิเพิ่มพลังงานและความชัดเจน พระพุทธเจ้าสอนว่า "ผู้ชนะในสงครามพันครั้ง สู้ชนะใจตัวเองไม่ได้" และให้ธรรมทาน: สอนความรู้ 1 เรื่องให้คนที่ต้องการ — ธรรมทานชนะทานทั้งปวง</div></div>'
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  ...
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการหาเงินเก่งและดึงดูดโอกาสใหญ่ๆ ได้ดี แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายเพื่อรักษาภาพลักษณ์"</span></div></div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้อาหาร/น้ำดื่มกับคนที่ต้องการ 1 ครั้งวันนี้ — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> (ปัจจัย 4) สัปปุริสทาน 8: ให้ของสะอาด ประณีต ตามกาล จิตผ่องใส</div></div>'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">ความอบอุ่นของคุณ มักดึงดูด <span class="cb-highlight">"คนที่มีบาดแผลทางใจ (คนที่มีบาดแผลทางใจ)"</span> หรือคนพังๆ ที่ต้องการคนเยียวยา คุณมักรับบทเป็นจิตแพทย์ประจำตัวให้พวกเขา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  + '<div class="lb-desc">ระวังคนที่มีอารมณ์รุนแรง (คนดูดพลังใจ) หรือคนที่เห็นความใจดีของคุณเป็นของตาย คนที่เอาแต่เล่าเรื่องแย่ๆ ของตัวเองโดยไม่เคยถามไถ่ความรู้สึกของคุณเลย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> เข็มทิศคัดกรองคนที่ใช่ (The Right Compass)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">คนธาตุน้ำรับอารมณ์คนอื่นมาเยอะ — แผ่เมตตาให้ตัวเองก่อน: <span class="cb-highlight">"นิททุกโข โหมิ — ขอให้ข้าพเจ้าปราศจากทุกข์"</span> 3 นาทีก่อนนอน และงดนินทา 7 วัน — น้ำนิ่ง = ใจนิ่ง</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการจับกระแสและรู้ความต้องการของผู้คน แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายตามอารมณ์"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">แยก "อารมณ์" ออกจาก "การเงิน" — จดรายจ่ายทุกวัน 7 วัน สติเรื่องเงิน = ปัญญาเรื่องเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานบริการ ดูแลคน หรืองานสร้างสรรค์จะเติบโตดี แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้อาหาร/ขนมคนชราหรือเด็ก 1 คน — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> แผ่เมตตาให้ตัวเอง: "ขอให้ข้าพเจ้ามีทรัพย์เพียงพอ" 3 นาทีก่อนนอน</div></div>'
  + '</div>',
  + '<div class="lb-desc">ต้องฝึกทักษะ <span class="cb-highlight">"ขอบเขตทางอารมณ์ (การตีเส้นขอบเขตอารมณ์)"</span> และ <span class="cb-highlight">"การกล้าแสดงออกอย่างเหมาะสม (การกล้าแสดงออกอย่างเหมาะสม)"</span> หัดพูดคำว่า "ไม่" ให้ชินปาก และแยกให้ออกว่า "ฟีดแบ็กเรื่องงาน" ไม่ใช่ "การโจมตีตัวบุคคล"</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">คุณมักดึงดูดความสัมพันธ์ที่ <span class="cb-highlight">"ร้อนแรงและดราม่า (ร้อนแรงและวุ่นวาย)"</span> บางครั้งอาจดึงดูดคนที่ชอบควบคุม หรือคนที่ยอมคุณมากเกินไปจนคุณรู้สึกเบื่อและหมดความท้าทาย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  + '<div class="lb-desc">ระวังคนที่ชอบชวนทะเลาะเพื่อกระตุ้นแพสชัน (แพสชันที่เป็นพิษ) หรือคนที่ใช้ความเงียบ (ความเงียบที่ใช้ลงโทษ) มาปั่นหัวคุณ เพราะมันจะทำให้คุณสติแตกและแสดงมุมที่ร้ายที่สุดออกมา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> เข็มทิศคัดกรองคนที่ใช่ (The Right Compass)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ก่อนพูดทุกครั้งวันนี้ หยุด 1 ลมหายใจ ถาม <span class="cb-highlight">"คำนี้จะสร้างสะพานหรือกำแพง?"</span> — ธาตุไฟในรักต้องควบคุมด้วยสติ แผ่เมตตาให้คนรัก 3 นาทีก่อนนอน</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณหาเงินเก่งจากพลังงานและความกล้า แต่หลุมพรางคือ <span class="cb-highlight">"การตัดสินใจเรื่องเงินตอนอารมณ์ร้อน"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">อย่าใช้เงินตอนโกรธหรือหงุดหงิด — หยุด 3 ลมหายใจก่อนจ่ายเงินก้อนใหญ่ ความใจร้อนระบายทรัพย์โดยไม่รู้ตัว</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานที่ต้องใช้พลังกายและใจจะเติบโต แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้แรงกายช่วยคน 1 อย่างวันนี้ — <span class="cb-highlight">ทานแรงกาย = ทานที่ใช้ร่างกายเป็นเครื่องมือ</span> แผ่เมตตาให้ตัวเอง 3 นาทีก่อนนอน</div></div>'
  + '</div>',
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ก่อนพูดทุกครั้งวันนี้ หยุด 1 ลมหายใจ ถาม <span class="cb-highlight">"คำนี้จะสร้างสะพานหรือกำแพง?"</span> — สตินำวาจา ลดกรรมทางวาจา (ศีล 4) และให้ธรรมทาน: สอนความรู้ 1 เรื่องให้คนที่ต้องการ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ต้องอัปสกิล <span class="cb-highlight">"การวางแผนกลยุทธ์ (การวางแผนกลยุทธ์)"</span> และ <span class="cb-highlight">"การจัดการความโกรธ (การจัดการอารมณ์โกรธ)"</span> ก่อนลุยงานทุกครั้งให้หยุดคิด 10 นาทีเพื่อวางแผนลดความเสี่ยง และฝึกใช้คำพูดเชิงบวก (ฟีดแบ็กเชิงบวก) เวลาวิจารณ์งานลูกน้อง</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง (Wealth Blueprint)</div>'
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการจับกระแสและรู้ความต้องการของผู้คน ซึ่งเป็นทักษะทำเงินชั้นยอด แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายตามอารมณ์ (Emotional Spending)"</span> เวลาเครียดหรือเศร้า คุณมักจะซื้อความสุขชั่วคราว หรือเปย์เพื่อเยียวยาคนอื่นจนลืมดูแลกระเป๋าตัวเอง หากคุณแยก "อารมณ์" ออกจาก "การเงิน" ได้ คุณจะมั่งคั่งอย่างเงียบๆ และยั่งยืน</div></div></div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">คุณมักดึงดูด <span class="cb-highlight">"คนคุยเก่ง หรือคนโลเล (ไม่สม่ำเสมอ)"</span> ที่เข้ามาทำให้ตื่นเต้นด้วยคำพูด แต่ขาดการกระทำที่ชัดเจน หรือบางครั้งก็ดึงดูดคนที่ฉลาดแต่เย็นชาทางอารมณ์</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณหาเงินเก่งจากความคิดและการสื่อสาร แต่หลุมพรางคือ <span class="cb-highlight">"การเริ่มหลายทางแต่ไม่จบสักทาง"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">เลือก 1 ช่องทางรายได้ ทำให้สำเร็จก่อนเริ่มใหม่ — สติเรื่องเงิน = ปัญญาเรื่องเงิน จดรายจ่ายทุกวัน 7 วัน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานเขียน สอน หรือที่ปรึกษาจะเติบโตดี แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้ธรรมทาน: สอนความรู้ 1 เรื่องให้คนที่ต้องการ — <span class="cb-highlight">ธรรมทานชนะทานทั้งปวง</span> (สพฺพทานํ ธมฺมทานํ ชินาติ)</div></div>'
  + '</div>',
  + '<div class="lb-desc">ให้ธรรมทานแก่คนรัก: <span class="cb-highlight">แชร์ความรู้ 1 เรื่องที่คุณเชี่ยวชาญ</span> — ธรรมทานชนะทานทั้งปวง และฟังก่อนตอบ หยุด 1 ลมหายใจ — สตินำวาจา</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> อุปนิสัยสกัดดาวรุ่ง (Career Blockers)</div>'
  + '<div class="lb-desc">อาการ <span class="cb-highlight">"รู้กว้างแต่ไม่ลึก (รู้กว้างแต่ยังไม่ลึก)"</span> สมาธิสั้นง่าย กระโดดจับโปรเจกต์ใหม่ตลอดเวลาจนลืมสานต่อโปรเจกต์เก่า และบางครั้งคิดมาก (คิดมากเกินไป) จนไม่ได้ลงมือทำ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">นั่งสมาธิ <span class="cb-highlight">3 นาที ดูลมหายใจ</span> — "พุท" เข้า "โธ" ออก จิตฟุ้งก็กลับมา ลมนิ่ง = จิตนิ่ง และให้ธรรมทาน: แชร์ความรู้ 1 เรื่องให้คนที่ต้องการ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ต้องฝึกฝน <span class="cb-highlight">"การจดจ่อเชิงลึก (การจดจ่อขั้นสุด)"</span> และสร้างทักษะแบบ <span class="cb-highlight">"ทักษะรูปตัวที"</span> คือรู้กว้างหลายเรื่อง แต่ต้องเลือก 1 เรื่องที่รู้ลึกระดับผู้เชี่ยวชาญ (ผู้เชี่ยวชาญ) เพื่อสร้างมูลค่าตัวให้แพงขึ้นในตลาดแรงงาน</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง (Wealth Blueprint)</div>'
  + '<div class="lb-desc">สมองที่ไวดั่งพายุคือเครื่องทุ่นแรงชั้นยอด คุณมองเห็นช่องทางทำเงินที่คนอื่นมองข้ามเสมอ แต่หลุมพรางคือ <span class="cb-highlight">"การจับปลาหลายมือ (Shiny Object Syndrome)"</span> คุณมักเริ่มทำหลายธุรกิจหรือหลายโปรเจกต์พร้อมกันแต่จบไม่ลง หากคุณหัดโฟกัสให้ลึกเป็นเรื่องๆ รายได้ของคุณจะพุ่งกระฉูดจากความเป็น ผู้เชี่ยวชาญ</div></div></div>',
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีโชคเรื่องเงินมาแต่เกิด แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายเกินตัวเพราะมั่นใจว่าจะมีเข้ามาเรื่อยๆ"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">อย่าประมาทเรื่องเงิน — สร้างนิสัยออมสม่ำเสมอ โชคชอบคนที่เตรียมตัวรับ ไม่ใช่คนที่รอให้โชคมาหา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานสอน ที่ปรึกษา หรือธุรกิจระหว่างประเทศจะเติบโต แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้ทาน 1 อย่างวันนี้ — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> แผ่เมตตาทั่วทุกทิศ 3 นาทีก่อนนอน — พรหมวิหาร 4 เป็นเครื่องอยู่ของจิตที่ประเสริฐ</div></div>'
  + '</div>',
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  + '<div class="lb-desc">ระวังคนที่ทำผิดเรื่องเดิมซ้ำซากและไม่ยอมพัฒนาตัวเอง (กรอบคิดตายตัว) เพราะมันจะดึงมาตรฐานชีวิตคุณให้ต่ำลง หรือคนที่มองว่าคำแนะนำของคุณคือการบ่นและจู้จี้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> เข็มทิศคัดกรองคนที่ใช่ (The Right Compass)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">แผ่เมตตาทั่วทุกทิศ 3 นาทีก่อนนอน: <span class="cb-highlight">"สัพเพ สัตตา สุขิตา โหนตุ"</span> — พรหมวิหาร 4: เมตตา กรุณา มุทิตา อุเบกขา เป็นเครื่องอยู่ของจิตที่ประเสริฐ</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> อุปนิสัยสกัดดาวรุ่ง (Career Blockers)</div>'
  + '<div class="lb-desc">การติดอยู่ในทฤษฎีมากเกินไปจนขาดทักษะปฏิบัติ <span class="cb-highlight">"(พูดมากแต่ไม่ลงมือ)"</span> การมองโลกในแง่ดีเกินเหตุทำให้ประเมินความเสี่ยงต่ำไป และบางครั้งเผลอสอนคนอื่น (สอนเกินจังหวะ) โดยที่เขาไม่ได้ขอคำแนะนำ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เปิดพระไตรปิฎกหรือฟังธรรม 1 เรื่อง เขียนลงสมุดว่า <span class="cb-highlight">"สิ่งที่เรียนรู้จะนำไปใช้ปรับชีวิตข้อใด"</span> — สุตมยปัญญา: ปัญญาจากการฟัง เป็นบันไดขั้นแรกสู่ปัญญาที่แท้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ต้องอัปสกิล <span class="cb-highlight">"ทักษะการลงมือทำ (ทักษะการลงมือทำ)"</span> เปลี่ยนวิสัยทัศน์ที่ยิ่งใหญ่ให้กลายเป็น รายการลงมือทำ เล็กๆ ที่ทำได้จริงในแต่ละวัน และเรียนรู้ "ศิลปะการให้คำปรึกษา" คือการตั้งคำถามให้เขาคิดเอง แทนที่จะบอกคำตอบทั้งหมด</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง (Wealth Blueprint)</div>'
  + '<div class="lb-desc">สมองที่ไวดั่งพายุคือเครื่องทุ่นแรงชั้นยอด คุณมองเห็นช่องทางทำเงินที่คนอื่นมองข้ามเสมอ แต่หลุมพรางคือ <span class="cb-highlight">"การจับปลาหลายมือ (Shiny Object Syndrome)"</span> คุณมักเริ่มทำหลายธุรกิจหรือหลายโปรเจกต์พร้อมกันแต่จบไม่ลง หากคุณหัดโฟกัสให้ลึกเป็นเรื่องๆ รายได้ของคุณจะพุ่งกระฉูดจากความเป็น ผู้เชี่ยวชาญ</div></div></div>',
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณหาเงินจากความสัมพันธ์และงานสร้างสรรค์ แต่หลุมพรางคือ <span class="cb-highlight">"การใช้เงินซื้อความสุขชั่วคราว"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">ตั้งงบสำหรับ beauty/entertainment ชัดเจนทุกเดือน — อย่าใช้เงินเยียวยาใจ ใช้สมาธิแทน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานออกแบบ ความงาม หรือ hospitality จะเติบโต แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนที่ช่วยเหลือเรื่องเงิน 1 คน — <span class="cb-highlight">เมตตาเริ่มจากคำพูดง่ายๆ</span> แผ่เมตตาให้ตัวเอง: "สุขิโต โหมิ" 3 นาทีก่อนนอน</div></div>'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">เสน่ห์ของคุณมักดึงดูด <span class="cb-highlight">"คนหลงตัวเอง (คนหลงตัวเอง)"</span> ที่ชอบให้คุณเอาอกเอาใจ หรือคนที่เข้ามาเพื่อเชยชมความสวยงามและโปรไฟล์ของคุณเพื่อเป็นเครื่องประดับบารมีเขา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนรัก 1 คนอย่างจริงใจวันนี้ — <span class="cb-highlight">เมตตาเริ่มจากคำพูดง่ายๆ</span> อย่ารอให้สาย และแผ่เมตตาให้ตัวเอง: "สุขิโต โหมิ" 3 นาทีก่อนนอน</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> อุปนิสัยสกัดดาวรุ่ง (Career Blockers)</div>'
  + '<div class="lb-desc">อาการ <span class="cb-highlight">"การเอาใจคนอื่นเกินพอดี"</span> (ชอบเอาใจคนอื่นจนตัวเองลำบาก) คุณเกลียดการปะทะ จึงยอมแบกงานของคนอื่นมาทำเอง อาการรักความสบายทำให้บางครั้งคุณขาดแรงผลักดัน (แรงขับเคลื่อน) ในการแข่งขันที่ดุเดือด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนรัก 1 คนอย่างจริงใจวันนี้ — <span class="cb-highlight">เมตตาเริ่มจากคำพูดง่ายๆ</span> อย่ารอให้สาย และแผ่เมตตาให้ตัวเอง: "สุขิโต โหมิ" 3 นาทีก่อนนอน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ต้องฝึก <span class="cb-highlight">"การเจรจาต่อรอง (การเจรจาต่อรอง)"</span> และ <span class="cb-highlight">"การตั้งขอบเขต (การขีดเส้นแบ่ง)"</span> คุณต้องกล้าเรียกค่าตัวให้คุ้มกับความสามารถ และเรียนรู้การปฏิเสธงานด้วยใบหน้าที่ยิ้มแย้ม ความเกรงใจไม่ช่วยให้กระเป๋าตังค์ตุงขึ้น</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง (Wealth Blueprint)</div>'
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณเก็บเงินเก่งและลงทุนอย่างมีกลยุทธ์ แต่หลุมพรางคือ <span class="cb-highlight">"การประหยัดจนไม่ยอมใช้เงินดูแลตัวเอง"</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">อย่าประหยัดจนทุกข์ — ลงทุนกับสุขภาพและความสุขบ้าง ชีวิตไม่ได้มีแค่ทำงานและเก็บเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานที่ต้องใช้ความละเอียดและความน่าเชื่อถือจะเติบโตช้าแต่มั่นคง แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เขียน 3 สิ่งที่ขอบคุณวันนี้ — <span class="cb-highlight">วันเสาร์ = วันทบทวน</span> แผ่เมตตาทั่วทุกทิศ 3 นาที และเดินจงกรม 10 นาที — กรรมฐาน 4 อิริยาบถ</div></div>'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">ความมั่นคงของคุณ มักดึงดูด <span class="cb-highlight">"คนที่ชีวิตวุ่นวาย (ชีวิตวุ่นวาย)"</span> ที่เข้ามาหาเกาะกำบัง หรือคนที่ชอบผลักภาระมาให้คุณแบก เพราะรู้ว่าคุณอดทนเก่งและไม่ทิ้งเขาแน่ๆ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนใกล้ตัว 1 คนอย่างจริงใจวันนี้ — <span class="cb-highlight">คนธาตุดินเก่งเรื่องแบก แต่ไม่เก่งเรื่องบอกรัก</span> เมตตาเริ่มจากคำพูดง่ายๆ อย่ารอให้สาย</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> อุปนิสัยสกัดดาวรุ่ง (Career Blockers)</div>'
  + '<div class="lb-desc">ความ <span class="cb-highlight">"เจ้าระเบียบเกินไป (เจ้าระเบียบเกินไป)"</span> และการยึดติดกับวิธีการเดิมๆ (ความแข็งตัวกับวิธีเดิม) การมองโลกในแง่ร้ายระแวงไปหมด ทำให้คุณเสียโอกาสใหม่ๆ และมักจะทำงานหนักเกินไปจนเกิดภาวะหมดไฟ (ภาวะหมดไฟ)</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เขียน 3 สิ่งที่ขอบคุณวันนี้ + แผ่เมตตาทั่วทุกทิศ 3 นาที — <span class="cb-highlight">วันเสาร์ = วันพักจิต</span> ทบทวนสัปดาห์ สร้างเหตุใหม่ และเดินจงกรม 10 นาที — กรรมฐาน 4 อิริยาบถ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ต้องอัปสกิล <span class="cb-highlight">"ความสามารถในการปรับตัว (ความสามารถในการปรับตัว)"</span> และ <span class="cb-highlight">"การทำงานอย่างชาญฉลาด"</span> หยุดคิดว่าต้องทำงานหนักถึงจะสำเร็จ ลองใช้เทคโนโลยีหรือระบบอัตโนมัติมาทุ่นแรง และอนุญาตให้งานเสร็จแค่ 80% (แล้วค่อยแก้) ดีกว่ารอ 100% แล้วไม่ได้ส่งงาน</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง (Wealth Blueprint)</div>'
  + '<div class="lb-desc">คุณคือราชาแห่งความมั่งคั่งระยะยาว เก็บเงินเก่งและลงทุนอย่างมีกลยุทธ์ แต่หลุมพรางคือ <span class="cb-highlight">"กรอบความคิดแบบขาดแคลน (Scarcity Mindset)"</span> คุณมักรู้สึกว่าเงินไม่เคยพอจนขี้เหนียวเกินไป และเชื่อว่าต้องทำงานหนักสายตัวแทบขาดถึงจะได้เงินมา หากคุณเรียนรู้เรื่อง "ทำงานให้ฉลาดขึ้น (การทำงานอย่างชาญฉลาด)" พอร์ตการเงินคุณจะโตแบบติดปีก</div></div></div>',
