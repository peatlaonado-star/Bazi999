...
var UI = {
  th: {
    tag:'✦ ค้นพบตัวเองผ่านดวงดาว ✦', ttl:'STARVIA', sub:'นพเคราะห์ · ราศีจักร · ลัคนา · ดวงชะตา',
  ...
  en: {
    tag:'✦ ค้นพบตัวเองผ่านดวงดาว ✦', ttl:'STARVIA', sub:'Navagraha · Zodiac · Lagna · Destiny',
...
lv: '<div class="love-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💬</span> ภาษาจีบและการสื่อสาร (ภาษารักของคุณ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">พลังงานความผู้นำของคุณ มักดึงดูด <span class="cb-highlight">"คนที่ต้องการที่พึ่งพิง (ต้องการที่พึ่งพิง)"</span> หรือคนที่ดูอ่อนแอกว่าเข้ามาหา เพราะเขาเห็นว่าคุณสามารถแบกรับชีวิตเขาได้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ แผ่เมตตาให้คนรัก 3 นาที: <span class="cb-highlight">"สุขิตา โหนตุ"</span> — เมตตานิสังสสูตร และหยุด 1 ลมหายใจก่อนพูด — สตินำวาจา (ศีล 4)</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"บุคลิกภาพผู้นำ"</span> (บุคลิกภาพผู้นำ) ที่ทำให้คนเกรงใจและเชื่อถือโดยธรรมชาติ มีวิสัยทัศน์กว้างไกล กล้าตัดสินใจในภาวะวิกฤต และมีพลังในการโน้มน้าวใจสูง</div></div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">นั่งสมาธิ <span class="cb-highlight">"พุท-โธ" 3 นาทีก่อนเริ่มงานทุกวัน</span> — สมาธิเพิ่มพลังงาน และให้ธรรมทาน: สอนความรู้ 1 เรื่อง — ธรรมทานชนะทานทั้งปวง</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">ระวังการใช้เงินซื้อความรักหรือซื้อยกย่อง — กฎ 24 ชั่วโมง: อยากซื้อของหรู ให้รอก่อน 1 วัน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงินเป็น 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — ใช้จากกำไร ไม่ใช่จากหนี้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้อาหาร/น้ำดื่มกับคนที่ต้องการ 1 ครั้งวันนี้ — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> (ปัจจัย 4) สัปปุริสทาน 8</div></div>'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💬</span> ภาษาจีบและการสื่อสาร (ภาษารักของคุณ)</div>'
  + '<div class="lb-desc">คุณสื่อสารความรักผ่าน "การดูแลเอาใจใส่ (การดูแลเอาใจใส่)" สังเกตรายละเอียดเล็กๆ น้อยๆ ของเขาได้เก่งมาก และมักใช้ความอ่อนโยนในการเข้าหา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">ความอบอุ่นของคุณ มักดึงดูดคนที่ต้องการการเยียวยา — เพราะคุณมีพลังที่อบอุ่นพอที่จะรักษาเขา แต่จงจำไว้ว่า รักที่แท้ไม่ใช่การรับบทหมอรักษาใจใคร แต่คือการที่หัวใจสองดวงได้พักด้วยกัน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีพลังในการดูแลผู้อื่นอย่างลึกซึ้ง แต่รักที่ดีต้องเริ่มจากการดูแลตัวเองก่อน ถามหัวใจตัวเองว่า "เขาทำให้ฉันรู้สึกสงบและปลอดภัยไหม?" คนที่ใช่จะไม่ดูดพลังคุณไปเรื่อยๆ — เขาจะเติมพลังให้คุณด้วย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — ส่งพลังดีถึงหัวใจ</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ หลับตา วางมือบนหัวใจ หายใจลึกๆ 3 ครั้ง ส่งความรู้สึกอบอุ่นถึงตัวเองก่อน — แล้วค่อยนึกถึงคนที่คุณรัก ส่งพลังดีๆ ถึงเขาโดยไม่ต้องคาดหวังอะไรกลับ — เมื่อเรารักตัวเองเป็น เราจะดึงดูดคนที่รักเราเป็น</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  + '<div class="lb-desc">คุณคือ <span class="cb-highlight">"นักเยียวยาและผู้ดูแล"</span> สายงานที่รุ่งเรืองที่สุดคืองานที่ต้องใช้ความละเอียดอ่อน เช่น จิตวิทยา, ทรัพยากรบุคคล ทรัพยากรบุคคล, การแพทย์และพยาบาล, งานบริการลูกค้าระดับ VIP, หรืองานศิลปะสร้างสรรค์</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"ความเห็นอกเห็นใจสูง"</span> (ความเห็นอกเห็นใจสูงปรี๊ด) อ่านบรรยากาศและอารมณ์คนรอบข้างออกอย่างทะลุปรุโปร่ง ทำให้คุณรับมือกับลูกค้าที่กำลังโมโห หรือไกล่เกลี่ยความขัดแย้งในทีมได้เนียนที่สุด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">คุณมีพลังในการดูแลและเข้าใจคนอื่นอย่างลึกซึ้ง — นั่นคือพรสวรรค์ แต่ต้องไม่ลืมดูแลตัวเอง ความเห็นอกเห็นใจที่ไม่มีขอบเขตจะกลายเป็นภาระ ฝึกแยก "เรื่องงาน" ออกจาก "ตัวตน" และหัดพูด "ไม่" ในสิ่งที่เกินกำลัง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ก่อนทำงานทุกเช้า หายใจลึกๆ 3 ครั้ง ตั้งใจว่า "วันนี้ฉันจะทำงานด้วยใจ ไม่ใช่ด้วยอารมณ์" และหัดพูดว่า "เรื่องนี้ฉันขอคิดก่อน" — ไม่ต้องตอบตกลงทันทีทุกเรื่อง แค่เปลี่ยนตรงนี้ คุณค่าของคุณในที่ทำงานจะเพิ่มขึ้น十倍</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการอ่านความต้องการของผู้คน ซึ่งเป็นทักษะทำเงินชั้นยอด แต่พลังงานเงินจะหมุนเวียนดีเมื่อคุณรู้จัก "ปล่อย" ไม่ใช่แค่ "เก็บ" — โดยเฉพาะเมื่อคุณรู้จักให้โดยไม่หวังผล</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">ความสามารถในการดูแลและเข้าใจคนอื่นกำลังจะเปิดช่องทางรายได้ใหม่ ลองสังเกตว่าเมื่อไหร่ที่คุณให้จากใจ เงินมักไหลกลับมาทางอื่นเสมอ วันนี้ให้อะไรเล็กน้อยกับใครสักคน แล้วดูความเปลี่ยนแปลง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — และก่อนซื้ออะไรตอนเครียด ให้หายใจลึก 3 ครั้ง ถามตัวเองว่า "ฉันต้องการ หรือแค่คิดถึง?"</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
...
pres: '<div class="lb-desc" style="line-height:1.8;">'
  + 'พลังงานชีวิตของคุณในช่วงนี้กำลังอยู่ในบททดสอบเรื่อง <span class="hl-gold">"การขีดเส้นขอบเขต (การตั้งขอบเขต)"</span> คุณกำลังเหนื่อยล้าจากการแบกรับปัญหาที่ไม่ได้ก่อ จักรวาลกำลังบีบให้คุณต้องเรียนรู้ที่จะพูดคำว่า "ไม่" เพื่อปกป้องพลังงานของตัวเองโดยไม่ต้องรู้สึกผิด'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💬</span> ภาษาจีบและการสื่อสาร (ภาษารักของคุณ)</div>'
  + '<div class="lb-desc">คุณรักแบบ "นักล่า" ชอบความท้าทาย สื่อสารตรงไปตรงมา ไม่ชอบเล่นเกมเดาใจ และมักแสดงความรักผ่านการกระทำ (การแสดงความรักผ่านการกระทำ) มากกว่าคำพูดหวานหู</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">คุณมักดึงดูดความสัมพันธ์ที่ร้อนแรง — เพราะคุณมีไฟที่แรงกล้า แต่จงจำไว้ว่า รักที่ใช่ไม่ใช่สนามรบที่ต้องชนะกัน แต่คือพื้นที่ที่คุณวางอาวุธลงแล้วรู้สึกปลอดภัย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีพลังที่ร้อนแรงและน่าดึงดูด แต่รักที่ใช่ต้องทำให้คุณสงบ ไม่ใช่เร่าร้อนตลอดเวลา คัดกรองด้วยหัวใจที่เย็นลงสักนิด — คนที่ใช่จะไม่ทำให้คุณต้องพิสูจน์ตัวเองผ่านการทะเลาะ หรือใช้ความเงียบลงโทษคุณ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — วางอาวุธลง</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ หลับตา หายใจเข้าลึกๆ 5 ครั้ง — แต่ละครั้งนึกถึงความสงบที่คุณอยากให้เกิดขึ้นในความรัก ส่งความรู้สึกนี้ถึงคนที่คุณรัก ไม่ต้องพูด ไม่ต้องทำ แค่ส่งคลื่นความสงบจากใจคุณ — แล้วดูว่าพรุ่งนี้พลังงานรอบตัวคุณเปลี่ยนยังไง</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  + '<div class="lb-desc">คุณคือ <span class="cb-highlight">"นักแก้ปัญหาสายลุย"</span> เติบโตได้ดีในงานที่ต้องขับเคี่ยวและมีความท้าทายรายวัน อาชีพที่เหมาะคือ วิศวกร, นักขายสายบุกเบิก นักขายเชิงรุก, ผู้ก่อตั้งสตาร์ทอัพ, กีฬา, ทหารตำรวจ หรืองานกู้ภัย/จัดการวิกฤต</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"ความไวในการลงมือทำ"</span> (ความไวในการลงมือทำ) คุณสามารถเปลี่ยนไอเดียให้เป็นรูปธรรมได้เร็วกว่าใคร ไม่กลัวงานหนัก และมีพลังงานเหลือล้นในการทะลวงอุปสรรคที่คนอื่นยอมแพ้ไปแล้ว</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">ความใจร้อนและเริ่มหลายอย่างแต่ไม่จบ — นั่นคือเพดานของคุณ พลังงานที่มีมากมายจะสูญเปล่าถ้าไม่มีเป้าหมายที่ชัดเจน ฝึกทำสิ่งเดียวให้เสร็จก่อนเริ่มใหม่ แล้วคุณจะเห็นว่ากำลังของคุณมีค่ามหาศาล</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ก่อนเริ่มงานทุกเช้า หายใจลึกๆ 5 ครั้ง ถามตัวเองว่า "วันนี้ฉันจะโฟกัสอะไรแค่อย่างเดียว" แล้วทำให้เสร็จก่อนเปิดโปรเจกต์ใหม่ และก่อนพูดอะไรเวลาหงุดหงิด ให้หายใจ 3 ครั้ง — คำพูดที่คิดก่อนย่อมมีพลังกว่าคำพูดที่พุ่งออกไปไร้สติ</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีพลังและความกล้าในการหาเงิน แต่พลังงานเงินจะหมุนเวียนดีเมื่อคุณรู้จัก "ปล่อย" — ไม่ใช่เมื่อคุณยึดติดกับทุกสิ่งที่หามาได้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">ความกล้าในการลงมือทำกำลังจะเปิดประตูทางการเงินครั้งสำคัญ แต่อย่าให้ความใจร้อนทำให้คุณตัดสินใจพลาด ลองให้อะไรเล็กน้อยกับใครสักคนวันนี้ แล้วดูว่าเมื่อคุณปล่อยมือ จักรวาลจะเติมเต็มให้คุณยังไง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — และก่อนซื้อของตอนหุนหัน ให้รอ 24 ชั่วโมง ถ้ายังอยากได้อยู่ค่อยซื้อ</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
  + 'อิทธิพลของดาวจันทร์สะท้อนปมในจิตใต้สำนึกเรื่อง <span class="hl-gold">"ความกลัวที่จะถูกทอดทิ้ง (Fear of Abandonment)"</span> ในอดีตคุณอาจต้องคอยสังเกตอารมณ์ผู้ใหญ่ หรือต้องทำตัวเป็นเด็กดีเพื่อแลกกับความรัก ปมนี้ทำให้คุณมักจะสวมบท "ผู้เยียวยา" โดยคิดว่าถ้าคุณเป็นที่พึ่งให้คนอื่นได้ เขาจะไม่ทิ้งคุณไป'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💬</span> ภาษาจีบและการสื่อสาร (ภาษารักของคุณ)</div>'
  + '<div class="lb-desc">คุณรักผ่าน "สมอง (เสน่ห์ทางความคิด)" การสื่อสารของคุณคือการหยอกล้อ แลกเปลี่ยนทัศนคติ และการถกเถียงเรื่องสนุกๆ คุณตกหลุมรักคนที่คุยกับคุณรู้เรื่อง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">คุณมักดึงดูดคนที่พูดเก่ง แต่การกระทำอาจไม่ตรงกับคำพูด — เพราะคุณหลงใหลในความคิดและการสื่อสาร แต่จงจำไว้ว่า รักที่แท้ต้องจับต้องได้ ไม่ใช่แค่สนทนาที่สวยหรู</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีเสน่ห์ทางความคิดที่ดึงดูดผู้คนรอบตัว แต่รักที่ใช่ต้องดูที่การกระทำ มากกว่าคำพูดสวยหรู ให้เวลากับคนที่ทำตามที่เขาพูด และจำไว้ว่า ความรักที่ดีต้องมีความรู้สึกอบอุ่นในหัวใจ ไม่ใช่แค่ความตื่นเต้นในสมอง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — เชื่อมต่อด้วยหัวใจ</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ หลับตา หายใจลึกๆ 3 ครั้ง วางมือบนหัวใจ ส่งความรู้สึกอบอุ่นถึงคนที่คุณรัก — ไม่ใช่ผ่านคำพูด ไม่ใช่ผ่านข้อความ แต่ส่งผ่านความรู้สึกจากใจจริง แล้วสังเกตว่าพรุ่งนี้พลังงานระหว่างคุณเปลี่ยนไปยังไง</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  + '<div class="lb-desc">คุณคือ <span class="cb-highlight">"นักสื่อสารและมันสมองของทีม"</span> รุ่งเรืองสุดๆ ในอุตสาหกรรมที่ต้องใช้ข้อมูลและการวิเคราะห์ อาชีพที่ใช่คือ นักการตลาด, นักวิเคราะห์ข้อมูล, สื่อสารมวลชน, นักเขียนโปรแกรม นักเขียนโปรแกรม, ทนายความ, หรือเซลส์สายให้คำปรึกษา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"ความยืดหยุ่นและวาทศิลป์"</span> (ความยืดหยุ่นและวาทศิลป์) คุณประมวลผลข้อมูลใหม่ๆ ได้ไวมาก จับต้นชนปลายเก่ง และสามารถอธิบายเรื่องยากๆ ให้คนทั่วไปเข้าใจและคล้อยตามได้อย่างน่าทึ่ง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">คุณมีสมองที่ว่องไวและเรียนรู้ได้เร็ว แต่พลังงานจะกระจายถ้าไม่มีโฟกัส เลือกหนึ่งเรื่องที่ใช่แล้วทำให้ลึกถึงระดับผู้เชี่ยวชาญ — ความรู้กว้างเป็นแต้มต่อ แต่ความลึกคือสิ่งที่ทำให้คุณค่าของคุณเพิ่มขึ้นแบบก้าวกระโดด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ทุกเช้า หายใจลึกๆ 3 ครั้ง ก่อนเปิดสมองรับข้อมูลใหม่ ถามตัวเองว่า "วันนี้ฉันจะโฟกัสเรื่องเดียวอะไรให้จบ" และปิดการแจ้งเตือนโทรศัพท์ 1 ชั่วโมงระหว่างวัน เพื่อให้สมองได้ทำงานลึก — นั่นคือเวลาที่คุณค่าที่แท้จริงของคุณถูกสร้างขึ้น</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมองเห็นโอกาสมากมาย แต่พลังงานเงินจะรวมศูนย์เมื่อคุณโฟกัสที่เดียว — ไม่ใช่เมื่อกระจายไปทุกที่ ความรู้และทักษะที่คุณสะสมไว้กำลังใกล้ถึงจุดแตกยอด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">ความรู้และทักษะที่คุณสะสมไว้กำลังใกล้ถึงจุดแตกยอด เลือกหนึ่งเรื่องที่ใช่ โฟกัสให้ลึก แล้วคุณจะเห็นว่ามูลค่าของคุณเพิ่มขึ้น十倍 แล้ววันนี้ลองแชร์ความรู้ที่มีค่าให้ใครสักคน 1 เรื่อง ความรู้ที่ให้ไปจะกลับมาเป็นโอกาสทางการเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — แล้ววันนี้ลองแชร์ความรู้ที่มีค่าให้ใครสักคน 1 เรื่อง ความรู้ที่ให้ไปจะกลับมาเป็นโอกาสทางการเงิน</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
  + 'อิทธิพลของดาวพุธซ่อนปมเรื่อง <span class="hl-gold">"อาการคิดมากเกินเหตุ (คิดมากเกินไป & Imposter Syndrome)"</span> คุณอาจมีความกลัวลึกๆ ว่าตัวเองยังเก่งไม่พอ จึงต้องคอยหาข้อมูลใหม่ๆ มาถมตลอดเวลา ทำให้สมองคุณไม่เคยได้พัก และติดลูปของการวิเคราะห์จนไม่ได้ลงมือทำ (Analysis Paralysis)'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">คุณมักดึงดูดคนที่ต้องการคำแนะนำ — เพราะคุณมีปัญญาและความอบอุ่นที่ผู้คนแสวงหา แต่จงจำไว้ว่า รักที่ใช่คือการเดินเคียงข้างกัน ไม่ใช่การสอนหรือชี้ทางให้ใคร</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีของขวัญคือปัญญาและการมองการณ์ไกล แต่อย่าให้ความสัมพันธ์กลายเป็นห้องเรียน จงเลือกคนที่พร้อมเติบโตไปพร้อมกับคุณ ไม่ใช่คนที่คุณต้องคอยสอนตลอดเวลา ความรักที่ดีคือการเดินทางร่วมกัน ไม่ใช่การนำทางฝ่ายเดียว</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — ส่งพลังจากใจ</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ หลับตา ส่งความรู้สึกอบอุ่นถึงคนที่คุณรัก โดยไม่ต้องสอน ไม่ต้องแนะนำ ไม่ต้องให้คำปรึกษาใดๆ แค่รู้สึกขอบคุณที่เขาเดินร่วมทางกับคุณ — ความรักที่แท้ไม่ต้องการคำแนะนำ มันต้องการแค่การยอมรับและพื้นที่ที่จะเติบโตไปด้วยกัน</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"การมองภาพใหญ่"</span> (การมองภาพใหญ่) และมีจริยธรรมสูง ผู้คนมักไว้ใจให้คุณถือครองความลับหรือทรัพยากรสำคัญ คุณสามารถมองเห็นแนวโน้มระยะยาวที่คนอื่นยังมองไม่เห็น</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">ความคิดที่ยิ่งใหญ่จะไร้ค่าถ้าไม่ลงมือทำ คุณเก่งเรื่องมองภาพใหญ่ แต่อย่าติดอยู่ในทฤษฎีจนลืมปฏิบัติ เลือกหนึ่งไอเดียที่ดีที่สุดแล้วลงมือทำวันนี้ ไม่ต้องรอให้พร้อม — เพราะความพร้อมไม่มีวันมาถึง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ทุกเช้า เลือก 3 อย่างที่ทำได้วันนี้จากวิสัยทัศน์ใหญ่ของคุณ — แล้วลงมือทำอย่างน้อย 1 อย่างก่อนเที่ยง และก่อนให้คำปรึกษาใคร ถามเขาก่อนว่า "อยากให้ฉันฟัง หรือให้คำแนะนำ?" — บางครั้งแค่ฟังก็มีค่ามากกว่าคำตอบทั้งหมด</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">โอกาสดีๆ รอบตัวคุณมีมากมาย แต่พลังงานเงินจะรวมศูนย์เมื่อคุณโฟกัส — ไม่ใช่เมื่อกระจาย ความรู้และปัญญาที่คุณมีคือทรัพย์สินที่มีค่าที่สุด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">โชคลาภและโอกาสกำลังเดินทางมา แต่จะมาในรูปแบบที่คุณคาดไม่ถึง จงเตรียมพื้นที่ในชีวิตให้พร้อมรับ ไม่ใช่ด้วยการวิ่งหาทุกโอกาส แต่ด้วยการเลือกสิ่งที่ใช่แล้วทุ่มเทให้เต็มที่</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — และวันนี้ลองแบ่งปันความรู้หรือประสบการณ์ให้ใครสักคนโดยไม่หวังผลตอบแทน — คุณจะเห็นว่าการให้คือการเปิดทางรับ</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
  + 'อิทธิพลของดาวพุธซ่อนปมเรื่อง <span class="hl-gold">"อาการคิดมากเกินเหตุ (คิดมากเกินไป & Imposter Syndrome)"</span> คุณอาจมีความกลัวลึกๆ ว่าตัวเองยังเก่งไม่พอ จึงต้องคอยหาข้อมูลใหม่ๆ มาถมตลอดเวลา ทำให้สมองคุณไม่เคยได้พัก และติดลูปของการวิเคราะห์จนไม่ได้ลงมือทำ (Analysis Paralysis)'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💬</span> ภาษาจีบและการสื่อสาร (ภาษารักของคุณ)</div>'
  + '<div class="lb-desc">คุณคือราชินี/ราชาแห่งความโรแมนติก สื่อสารความรักผ่านสุนทรียภาพ การสัมผัส และการเอาใจใส่ (การเอาใจคนอื่นเกินพอดี) คุณพร้อมปรับตัวเพื่อลดความขัดแย้งเสมอ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">เสน่ห์ของคุณดึงดูดคนมากมาย — แต่จงเลือกคนที่เห็นคุณค่าในตัวคุณ ไม่ใช่เพียงภาพลักษณ์ที่คุณสร้างขึ้น รักที่แท้ไม่ต้องการให้คุณสมบูรณ์แบบตลอดเวลา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีเสน่ห์และพลังในการดึงดูดโดยธรรมชาติ แต่อย่าให้ความสวยงามภายนอกเป็นเกณฑ์ตัดสินความรัก คนที่ใช่จะรักคุณในวันที่คุณไม่ได้แต่งตัวสวย ในวันที่คุณอ่อนแอ และในวันที่คุณปฏิเสธเขา ความรักที่แท้ไม่ต้องการให้คุณแสดงบทตลอดเวลา</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — รักตัวเองก่อน</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ ยืนหน้ากระจก มองตาตัวเอง แล้วพูดกับตัวเองด้วยความจริงใจว่า "ฉันมีค่าไม่ว่าวันนี้จะเป็นยังไง" ส่งความรู้สึกอบอุ่นถึงหัวใจตัวเอง แล้วค่อยนึกถึงคนที่คุณรัก สิ่งที่คุณให้เขาได้ดีที่สุดคือการรักตัวเองเป็น — เพราะรักแท้เริ่มต้นที่ตัวเรา</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  + '<div class="lb-desc">คุณคือ <span class="cb-highlight">"นักสร้างสรรค์และนักการทูต"</span> เติบโตสุดขีดในวงการที่ขับเคลื่อนด้วยสุนทรียภาพและภาพลักษณ์ อาชีพที่ใช่คือ ดีไซเนอร์, อินฟลูเอนเซอร์, นักประชาสัมพันธ์ ประชาสัมพันธ์, งานบริการระดับพรีเมียม, หรือนักเจรจาการค้าระหว่างประเทศ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"เครือข่ายและรสนิยม"</span> (รสนิยมล้ำเลิศและคอนเนกชั่น) คุณสามารถละลายพฤติกรรมคนแปลกหน้าให้กลายเป็นมิตรได้ใน 5 นาที และมีพรสวรรค์ในการทำให้สินค้า/บริการดูแพงและมีมูลค่าสูงขึ้น</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">การเอาใจคนอื่นจนตัวเองลำบากคือเพดานของคุณ คุณมีพรสวรรค์ในการสร้างเครือข่ายและความสัมพันธ์ แต่อย่าให้ความเกรงใจทำให้คุณสูญเสียคุณค่า ฝึกพูด "ไม่" อย่างสุภาพ และกล้าเรียกค่าตัวให้สมกับความสามารถ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ทุกเช้า ยิ้มให้ตัวเองในกระจก แล้วพูดว่า "วันนี้ฉันจะเลือกทำสิ่งที่ดีต่อฉัน" ก่อนรับปากใคร ให้หายใจ 3 ครั้งแล้วถามตัวเองว่า "ฉันอยากทำจริงๆ หรือแค่เกรงใจ?" — คำตอบนั้นจะเป็นเข็มทิศให้คุณเติบโต</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีรสนิยมดีและชอบสิ่งที่สวยงาม — แต่พลังงานเงินจะหมุนเวียนดีเมื่อคุณใช้เงินด้วยสติ ไม่ใช่ด้วยอารมณ์ ความสามารถในการสร้างเครือข่ายกำลังจะเปิดประตูทางการเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">ความสามารถในการสร้างเครือข่ายและมนุษยสัมพันธ์กำลังจะเปิดประตูทางการเงินครั้งสำคัญ จงกล้าเรียกค่าตัวให้สมกับคุณค่าที่คุณให้ และจำไว้ว่า การให้โดยไม่หวังผลเป็นแม่เหล็กดึงดูดทรัพย์</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — และก่อนซื้อของแพงเพื่อปลอบใจ ให้หยุดหายใจ 3 ครั้ง ถามว่า "ฉันต้องการ หรือแค่เครียด?"</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
  + 'ดาวศุกร์สะท้อนปมในใจเรื่อง <span class="hl-gold">"การหลีกเลี่ยงความขัดแย้ง (การเอาใจคนอื่นเกินพอดี)"</span> ในอดีตคุณอาจเรียนรู้ว่า การทำตัวน่ารักและโอนอ่อนผ่อนตามคือวิธีเอาตัวรอด ทำให้คุณมักจะกดทับความต้องการจริงๆ ของตัวเองไว้ เพื่อรักษาสันติภาพและทำให้ทุกคนรอบตัวพอใจ'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧲</span> แรงดึงดูดที่คุณมักเจอ (แพตเทิร์นแรงดึงดูด)</div>'
  + '<div class="lb-desc">ความมั่นคงของคุณดึงดูดคนที่ต้องการที่พึ่ง — เพราะคุณคือเสาหลักที่แข็งแรง แต่จงจำไว้ว่า รักที่ใช่ไม่ใช่ภาระที่คุณต้องแบก แต่คือสถานที่ที่คุณได้พักเช่นกัน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> แนวทางที่ใช่สำหรับคุณ</div>'
  + '<div class="lb-desc">คุณมีความอดทนและความรับผิดชอบสูง แต่อย่าให้ความรักกลายเป็นสนามทดสอบความอึด คนที่ใช่จะไม่มาเพิ่มภาระให้คุณ — เขาจะมาแบ่งเบา และทำให้ชีวิตคุณเบาขึ้น สังเกตว่าใครที่อยู่กับคุณแล้วคุณรู้สึกเบาสบาย ไม่ใช่หนักอึ้ง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> tonight — วางภาระลง</div>'
  + '<div class="lb-desc">ก่อนนอนคืนนี้ หลับตา หายใจลึกๆ 3 ครั้ง นึกถึงสิ่งที่ทำให้คุณรู้สึกหนักใจในความรัก แล้วหายใจออกปล่อยมันไป ส่งความรู้สึกขอบคุณถึงคนที่คุณรักโดยไม่ต้องแบกอะไร — แค่รู้สึกดีที่เขาอยู่ในชีวิต คุณสมควรได้รับความรักที่เบาสบาย ไม่ใช่ภาระที่ต้องแบก</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  + '<div class="lb-desc">คุณคือ <span class="cb-highlight">"นักสร้างรากฐานและผู้คุมระบบ"</span> งานที่ต้องใช้ความน่าเชื่อถือและความอึดขั้นสุดคือทางของคุณ อาชีพที่เหมาะคือ ผู้เชี่ยวชาญด้านการเงิน, วิศวกรโครงสร้าง, อสังหาริมทรัพย์, นักวิจัย, หรืองานตรวจสอบคุณภาพ ตรวจสอบคุณภาพ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> ทักษะติดตัวที่เป็นทุนเดิม (ทักษะติดตัว)</div>'
  + '<div class="lb-desc">มี <span class="cb-highlight">"ความอึดและวินัยสูง"</span> (ความอึดและวินัยเหล็ก) เมื่อคนอื่นทิ้งงานไปเพราะความยาก คุณคือคนที่อยู่จนวินาทีสุดท้ายเพื่อทำให้มันสำเร็จ ความน่าเชื่อถือของคุณคือทุนชีวิตที่แพงที่สุด</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🌱</span> จุดเติบโตที่ควรมอง</div>'
  + '<div class="lb-desc">การยึดติดกับวิธีการเดิมๆ และความสมบูรณ์แบบกำลังจำกัดการเติบโตของคุณ คุณมีพลังที่จะสร้างรากฐานที่แข็งแกร่ง แต่ต้องรู้จักปล่อยบางครั้ง อนุญาตให้งานเสร็จแค่ 80% แล้วค่อยปรับปรุง — ดีกว่ารอ 100% แล้วไม่ได้ส่งงาน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  + '<div class="lb-desc">ทุกเช้า หายใจลึกๆ 3 ครั้ง ก่อนลุยงาน ถามตัวเองว่า "วันนี้ฉันจะทำงานสำคัญที่สุดแค่ 3 อย่าง" แทนที่จะพยายามทำทุกอย่างให้สมบูรณ์ และหาเวลาพัก 10 นาทีระหว่างวัน — ไม่ใช่เพราะคุณขี้เกียจ แต่เพราะร่างกายคุณต้องการมัน ความสำเร็จที่ยั่งยืนไม่ใช่การวิ่งเร็ว แต่คือการวิ่งได้นาน</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีความสามารถในการสร้างความมั่นคงทางการเงินสูง แต่พลังงานเงินจะหมุนเวียนดีเมื่อคุณเชื่อว่ามีพอ — ไม่ใช่เมื่อคุณหวงทุกอย่างไว้</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">✨</span> โอกาสที่กำลังเปิด</div>'
  + '<div class="lb-desc">ผลจากการสะสมและความอดทนที่ผ่านมากำลังใกล้ถึงจุดเก็บเกี่ยว แต่อย่าลืมให้รางวัลตัวเองบ้าง ความมั่งคั่งที่แท้จริงไม่ใช่แค่ตัวเลขในบัญชี แต่คืออิสรภาพในการใช้ชีวิต ลองให้อะไรเล็กน้อยกับใครสักคนวันนี้ — แล้วดูว่าใจคุณเปิดออกยังไง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span> — และอย่าลืมมีช่องที่ 4 คือ "ใช้กับความสุข" เพราะเงินที่ไม่ถูกใช้คือพลังงานที่ถูกขัง ความมั่งคั่งที่แท้จริงคือสมดุลระหว่างการเก็บและการใช้</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
...
pres: '<div class="lb-desc" style="line-height:1.8;">'
  + 'ตอนนี้ชีวิตคุณกำลังเผชิญกับ <span class="hl-gold">"เพดานความสมบูรณ์แบบ (เจ้าระเบียบเกินไป Trap)"</span> คุณทำงานหนักจนแทบไม่มีเวลาใช้ชีวิต และรู้สึกหนักอึ้งเหมือนแบกโลกไว้ จักรวาลกำลังกระชากคุณให้เห็นว่า การยึดติดกับวิธีการเดิมๆ และไม่ยอมกระจายงานให้คนอื่น กำลังเป็นตัวถ่วงความเจริญเสียเอง'
  + '</div>',
...
(function() {
  ...
  var newsletterBirthdate = document.getElementById('newsletter-birthdate');
  ...
  newsletterForm.addEventListener('submit', async function(e) {
    ...
    var birthdate = newsletterBirthdate.value;
    ...
    newsletterBtn.textContent = 'กำลังสมัคร...';
    
    try {
      var apiBase = (window.STARVIA_CONFIG && window.STARVIA_CONFIG.apiBaseUrl) || '/v1';
      var response = await fetch(apiBase + '/newsletter/subscribe', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email: email, birthdate: birthdate || null })
      });
      ...
      if (result.success) {
        ...
        newsletterBtn.textContent = '✦ สมัครเลย ✦';
      }
    } catch (err) {
