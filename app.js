...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">คนธาตุน้ำรับอารมณ์คนอื่นมาเยอะ — แผ่เมตตาให้ตัวเองก่อน: <span class="cb-highlight">"นิททุกโข โหมิ"</span> 3 นาทีก่อนนอน และงดนินทา 7 วัน — น้ำนิ่ง = ใจนิ่ง</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> อุปนิสัยสกัดดาวรุ่ง (Career Blockers)</div>'
  + '<div class="lb-desc">คุณมัก <span class="cb-highlight">"นำเรื่องงานมาปนกับคุณค่าส่วนตัว"</span> เมื่อโดนตำหนิเรื่องงาน คุณจะรู้สึกว่าเขาไม่ชอบคุณ การหลีกเลี่ยงการเผชิญหน้า (การเลี่ยงความขัดแย้ง) ทำให้คุณเสียเปรียบในการเจรจาต่อรอง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🚀</span> แนวทางอัปสกิลสู่จุดสูงสุด (แนวทางเติบโต)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">แผ่เมตตาให้หัวหน้า/เพื่อนร่วมงานที่ขัดใจ 3 นาทีก่อนนอน — <span class="cb-highlight">ลดเวร เปิดทางงาน</span> และให้เวลาคนรับฟัง 15 นาที — แค่ฟัง ไม่ต้องแก้</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการจับกระแสและรู้ความต้องการของผู้คน ซึ่งเป็นทักษะทำเงินชั้นยอด แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายตามอารมณ์ (Emotional Spending)"</span> เวลาเครียดหรือเศร้า คุณมักจะซื้อความสุขชั่วคราว หรือเปย์เพื่อเยียวยาคนอื่นจนลืมดูแลกระเป๋าตัวเอง หากคุณแยก "อารมณ์" ออกจาก "การเงิน" ได้ คุณจะมั่งคั่งอย่างเงียบๆ และยั่งยืน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">แยก "อารมณ์" ออกจาก "การเงิน" — จดรายจ่ายทุกวัน 7 วัน สติเรื่องเงิน = ปัญญาเรื่องเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานบริการ ดูแลคน หรืองานสร้างสรรค์จะเติบโตดี แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้อาหาร/ขนมคนชราหรือเด็ก 1 คน — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> แผ่เมตตาให้ตัวเอง 3 นาทีก่อนนอน</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ก่อนพูดทุกครั้งวันนี้ หยุด 1 ลมหายใจ ถาม <span class="cb-highlight">"คำนี้จะสร้างสะพานหรือกำแพง?"</span> — ธาตุไฟในรักต้องควบคุมด้วยสติ</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ก่อนพูดทุกครั้งวันนี้ หยุด 1 ลมหายใจ ถาม <span class="cb-highlight">"คำนี้จะสร้างสะพานหรือกำแพง?"</span> — สตินำวาจา (ศีล 4) และให้ธรรมทาน: สอนความรู้ 1 เรื่อง</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณมีสัญชาตญาณในการจับกระแสและรู้ความต้องการของผู้คน ซึ่งเป็นทักษะทำเงินชั้นยอด แต่หลุมพรางคือ <span class="cb-highlight">"การใช้จ่ายตามอารมณ์ (Emotional Spending)"</span> เวลาเครียดหรือเศร้า คุณมักจะซื้อความสุขชั่วคราว หรือเปย์เพื่อเยียวยาคนอื่นจนลืมดูแลกระเป๋าตัวเอง หากคุณแยก "อารมณ์" ออกจาก "การเงิน" ได้ คุณจะมั่งคั่งอย่างเงียบๆ และยั่งยืน</div></div>'
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> สัญญาณที่ควรระวังและคนที่ควรคัดกรอง</div>'
  + '<div class="lb-desc">ระวังคนที่ดีแต่ปาก (พูดเก่งแต่ไม่ลงมือ) คนที่ขายฝันแต่ไม่เคยทำตามสัญญา หรือคนที่พยายามเอาชนะคุณด้วยวาทศิลป์โดยไม่เคยซัพพอร์ตความรู้สึกของคุณเลย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧭</span> เข็มทิศคัดกรองคนที่ใช่ (The Right Compass)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ให้ธรรมทานแก่คนรัก: <span class="cb-highlight">แชร์ความรู้ 1 เรื่องที่คุณเชี่ยวชาญ</span> — ธรรมทานชนะทานทั้งปวง และฟังก่อนตอบ หยุด 1 ลมหายใจ</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">นั่งสมาธิ <span class="cb-highlight">3 นาที ดูลมหายใจ</span> — "พุท" เข้า "โธ" ออก ลมนิ่ง = จิตนิ่ง และให้ธรรมทาน: แชร์ความรู้ 1 เรื่อง</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">สมองที่ไวดั่งพายุคือเครื่องทุ่นแรงชั้นยอด คุณมองเห็นช่องทางทำเงินที่คนอื่นมองข้ามเสมอ แต่หลุมพรางคือ <span class="cb-highlight">"การจับปลาหลายมือ (Shiny Object Syndrome)"</span> คุณมักเริ่มทำหลายธุรกิจหรือหลายโปรเจกต์พร้อมกันแต่จบไม่ลง หากคุณหัดโฟกัสให้ลึกเป็นเรื่องๆ รายได้ของคุณจะพุ่งกระฉูดจากความเป็น ผู้เชี่ยวชาญ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">เลือก 1 ช่องทางรายได้ ทำให้สำเร็จก่อนเริ่มใหม่ — สติเรื่องเงิน = ปัญญาเรื่องเงิน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานเขียน สอน หรือที่ปรึกษาจะเติบโตดี แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก์</div>'
  + '<div class="lb-desc">ให้ธรรมทาน: สอนความรู้ 1 เรื่อง — <span class="cb-highlight">ธรรมทานชนะทานทั้งปวง</span></div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">แผ่เมตตาทั่วทุกทิศ 3 นาทีก่อนนอน: <span class="cb-highlight">"สัพเพ สัตตา สุขิตา โหนตุ"</span> — พรหมวิหาร 4 เป็นเครื่องอยู่ของจิตที่ประเสริฐ</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เปิดพระไตรปิฎกหรือฟังธรรม 1 เรื่อง <span class="cb-highlight">สุตมยปัญญา: ปัญญาจากการฟัง</span> เป็นบันไดขั้นแรกสู่ปัญญาที่แท้</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">สมองที่ไวดั่งพายุคือเครื่องทุ่นแรงชั้นยอด คุณมองเห็นช่องทางทำเงินที่คนอื่นมองข้ามเสมอ แต่หลุมพรางคือ <span class="cb-highlight">"การจับปลาหลายมือ (Shiny Object Syndrome)"</span> คุณมักเริ่มทำหลายธุรกิจหรือหลายโปรเจกต์พร้อมกันแต่จบไม่ลง หากคุณหัดโฟกัสให้ลึกเป็นเรื่องๆ รายได้ของคุณจะพุ่งกระฉูดจากความเป็น ผู้เชี่ยวชาญ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">อย่าประมาทเรื่องเงิน — สร้างนิสัยออมสม่ำเสมอ โชคชอบคนที่เตรียมตัวรับ</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานสอน ที่ปรึกษา หรือธุรกิจระหว่างประเทศจะเติบโต แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก์</div>'
  + '<div class="lb-desc">ให้ทาน 1 อย่างวันนี้ — <span class="cb-highlight">ทานเปิดกระแสทรัพย์</span> แผ่เมตตาทั่วทุกทิศ 3 นาที — พรหมวิหาร 4</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
  + 'อิทธิพลของดาวพุธซ่อนปมเรื่อง <span class="hl-gold">"อาการคิดมากเกินเหตุ (คิดมากเกินไป & Imposter Syndrome)"</span> คุณอาจมีความกลัวลึกๆ ว่าตัวเองยังเก่งไม่พอ จึงต้องคอยหาข้อมูลใหม่ๆ มาถมตลอดเวลา ทำให้สมองคุณไม่เคยได้พัก และติดลูปของการวิเคราะห์จนไม่ได้ลงมือทำ (Analysis Paralysis)'
  + '</div>',
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนรัก 1 คนอย่างจริงใจวันนี้ — <span class="cb-highlight">เมตตาเริ่มจากคำพูดง่ายๆ</span> แผ่เมตตาให้ตัวเอง: "สุขิโต โหมิ" 3 นาทีก่อนนอน</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
...
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณดึงดูดทรัพย์ผ่านมนุษยสัมพันธ์และศิลปะในการเจรจา แต่หลุมพรางที่น่ากลัวที่สุดคือ <span class="cb-highlight">"การซื้อความสุขและหน้าตา"</span> คุณมักเปย์ของแบรนด์เนมหรือทริปหรูเพื่อกลบความเครียด (Lifestyle Creep) และมักจะอายที่จะเจรจาต่อรองเรื่องเงินตรงๆ หากคุณกล้าเรียกค่าตัวให้สมกับความสามารถ ความมั่งคั่งจะหลั่งไหลมาไม่ขาดสาย</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">ตั้งงบ beauty/entertainment ชัดเจนทุกเดือน — อย่าใช้เงินเยียวยาใจ ใช้สมาธิแทน</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานออกแบบ ความงาม หรือ hospitality จะเติบโต แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก์</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนที่ช่วยเรื่องเงิน 1 คน — <span class="cb-highlight">เมตตาเริ่มจากคำพูดง่ายๆ</span> แผ่เมตตาให้ตัวเอง 3 นาที</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
...
lv: '<div class="love-blueprint">'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💛</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">ชม/ขอบคุณคนใกล้ตัว 1 คนอย่างจริงใจ — <span class="cb-highlight">คนธาตุดินเก่งเรื่องแบก แต่ไม่เก่งเรื่องบอกรัก</span> เมตตาเริ่มจากคำพูดง่ายๆ</div></div>'
  + '</div>',
ca: '<div class="career-blueprint">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🎯</span> สายอาชีพที่เปิดทางรุ่ง (เส้นทางอาชีพที่เหมาะ)</div>'
  ...
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🧘</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เขียน 3 สิ่งที่ขอบคุณวันนี้ + แผ่เมตตาทั่วทุกทิศ 3 นาที — <span class="cb-highlight">วันเสาร์ = วันพักจิต</span> ทบทวนสัปดาห์ สร้างเหตุใหม่</div></div>'
  + '</div>',
mn: '<div class="career-blueprint" style="border-left-color:#8B6914; background:linear-gradient(135deg, rgba(201,162,39,0.05), rgba(139,105,20,0.08));">'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">💰</span> พิมพ์เขียวความมั่งคั่ง</div>'
  + '<div class="lb-desc">คุณคือราชาแห่งความมั่งคั่งระยะยาว เก็บเงินเก่งและลงทุนอย่างมีกลยุทธ์ แต่หลุมพรางคือ <span class="cb-highlight">"กรอบความคิดแบบขาดแคลน (Scarcity Mindset)"</span> คุณมักรู้สึกว่าเงินไม่เคยพอจนขี้เหนียวเกินไป และเชื่อว่าต้องทำงานหนักสายตัวแทบขาดถึงจะได้เงินมา หากคุณเรียนรู้เรื่อง "ทำงานให้ฉลาดขึ้น (การทำงานอย่างชาญฉลาด)" พอร์ตการเงินคุณจะโตแบบติดปีก</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">⚠️</span> จุดรั่วที่ต้องปิด</div>'
  + '<div class="lb-desc">อย่าประหยัดจนทุกข์ — ลงทุนกับสุขภาพและความสุขบ้าง</div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">📈</span> แนวทางสร้างความมั่งคั่ง</div>'
  + '<div class="lb-desc">รายได้จากงานที่ใช้ความละเอียดจะเติบโตช้าแต่มั่นคง แบ่งเงิน 3 ช่อง: <span class="cb-highlight">จำเป็น / สำรอง / ลงทุน</span></div></div>'
  + '<div class="lb-section"><div class="cb-title"><span style="font-size:14px">🍚</span> เหตุเสริมจากพระไตรปิฎก</div>'
  + '<div class="lb-desc">เขียน 3 สิ่งที่ขอบคุณวันนี้ — <span class="cb-highlight">วันเสาร์ = วันทบทวน</span> แผ่เมตตาทั่วทุกทิศ 3 นาที</div></div>'
  + '</div>',
past: '<div class="lb-desc" style="line-height:1.8;">'
