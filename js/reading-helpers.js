...
function buildMonthlyLifeMap(p, r, l, birthDate, today){
  ...
  return {
    ...
    domains: (cfg.domains || FALLBACK_MONTHLY_LIFE_MAP.domains).map(function(domain, index){
      ...
      var domainActions = {
        career: [
          'จุดธูป 3 ดอก ตั้งจิตอธิษฐานเรื่องงานก่อนออกจากบ้านทุกวัน 7 วันติด',
          'เขียนชื่องานที่อยากปิดลงในกระดาษ แล้วพกไว้ในกระเป๋าสตางค์',
          'สวดมนต์บท "นะโม 3 จบ" ก่อนเริ่มงานทุกวัน ตั้งจิตให้นิ่ง',
          'จัดโต๊ะทำงานให้โล่ง ทิศตะวันออกเปิดรับพลังงานใหม่'
        ],
        money: [
          'แบ่งเงินเป็น 3 ช่อง: จำเป็น / สำรอง / เสี่ยง แล้วปิดฝาช่องเสี่ยงไว้',
          'พกแบงค์ 500 ใหม่เอี่ยมไว้ในกระเป๋าสตางค์ 7 วัน เป็นเคล็ดเรียกทรัพย์',
          'จดรายจ่ายทุกวันเป็นเวลา 1 สัปดาห์ — ดาวการเงินจะเปิดเผยจุดรั่ว',
          'ถ้ามีของใหญ่อยากซื้อ รอ 2 สัปดาห์ ให้ดาวเปลี่ยนก่อนค่อยตัดสินใจ'
        ],
        windfall: [
          'จดเลขที่เจอซ้ำรอบตัวไว้ 3 วันติด — ถ้าเลขตรงกัน ให้ลองเสี่ยง',
          'ตั้งงบเสี่ยงไว้ล่วงหน้า เมื่อถึงให้หยุดทันที ไม่ไล่ทุน',
          'ดูเลขจากวันเกิด วันพระ และวันสำคัญรอบตัวเดือนนี้',
          'ถ้าฝันเห็นตัวเลข ให้จดไว้ก่อนตื่น แล้วลองเสี่ยงเล็ก ๆ'
        ],
        relationship: [
          'พูดความต้องการ 1 เรื่องที่ยังไม่เคยบอก — ดาวสื่อสารเปิด',
          'ฟังก่อนตอบ นับ 1-3 ในใจก่อนพูด — ถ้อยคำมีพลังเป็นพิเศษ',
          'นัดคุยตอนใจนิ่ง อย่าคุยตอนหงุดหงิด — จันทร์เต็มดวงส่งผล',
          'ส่งข้อความหาคนที่คิดถึงสัก 1 คนวันนี้ — ความรักเริ่มจากการเอื้อมออกไป'
        ],
        health: [
          'นอนให้ตรงเวลา 7 วันติดกัน — ร่างกายจะตอบแทนด้วยพลังงานที่เพิ่มขึ้น',
          'พักสายตาทุก 1 ชั่วโมง — ดาวพุธส่งผลต่อระบบประสาท',
          'ทำ routine เล็ก ๆ 7 วันติดกัน เช่น เดิน 15 นาที ยืดเหยียด 5 นาที',
          'ดื่มน้ำให้ครบ 8 แก้วทุกวัน — ธาตุน้ำในตัวต้องสมดุล'
        ]
      };
      var omenPool = {
        career: [
