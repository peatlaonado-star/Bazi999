...
function renderAusp(nm,p,pw,u){
  ...
  var nextWanPhra = getNextWanPhra(now);
  var VINAI = {
    'ไฟ': {
      title: '🔥 เหตุเสริมสำหรับธาตุไฟ',
      subtitle: 'เปลี่ยนความร้อนแรงเป็นพลังนำทาง',
      steps: [
        { icon: '🍚', name: 'ทาน — ให้น้ำดื่ม', action: 'ซื้อน้ำดื่ม 3 ขวด ให้คนทำงานกลางแดด รปภ. หรือแม่บ้าน — ธาตุไฟให้ธาตุน้ำ = ดับร้อนในใจ', why: 'ทานน้ำ = อานิสงส์สูง เพราะเป็นปัจจัย 4 (ให้ชีวิต)', level: 'อามิสทาน · เนื้อนาบุญปุถุชนผู้มีศีล' },
        { icon: '🙏', name: 'ศีล 5 + ศีล 8 วันพระ', action: 'ถือศีล 5 ทุกวัน — แล้วถือศีล 8 ในวันพระถัดไป ' + nextWanPhra.dateStr + ' (' + nextWanPhra.dayName + ')', why: 'ศีล 8 วันพระได้อานิสงส์ 100 เท่าของวันปกติ สงบไฟในตัว', level: 'ศีล 5 ทุกวัน + ศีล 8 วันพระ' },
        { icon: '💛', name: 'เมตตา — ดับไฟในใจ', action: 'ก่อนนอนคืนนี้ หลับตา 3 นาที แล้วสวด: "สุขิโต โหมิ — ขอให้ข้าพเจ้ามีความสุข / อเวโร โหมิ — ปราศจากเวร"', why: 'เมตตานิสังสสูตร: หลับสุข ตื่นสุข จิตตั้งมั่นเร็ว ผิวพรรณผ่องใส', level: 'เมตตาภาวนา · แผ่ให้ตัวเองก่อน แล้วขยายไปทั่วทุกทิศ' },
        { icon: '🧠', name: 'ปัญญา — อานาปานสติ', action: 'นั่งสมาธิ 5 นาที กำหนด "พุท" (เข้า) "โธ" (ออก) — ไม่บังคับลม หายใจตามธรรมชาติ จิตฟุ้งก็กลับมาที่ลมอย่างนุ่มนวล', why: 'อานาปานสติ = กรรมฐานที่พระพุทธเจ้าสอนเอง เป็นรากฐานของสมาธิทั้งหมด', level: 'ภาวนามยปัญญา · นั่งสมาธิ 5-10 นาที/วัน' }
      ],
      weekChallenge: '🎯 แบบฝึก 7 วันธาตุไฟ:\nจันทร์: ตั้งจิต "พุท-โธ" 3 นาทีก่อนเริ่มงาน\nอังคาร: ให้น้ำดื่ม 1 ขวดกับคนทำงานกลางแดด\nพุธ: แผ่เมตตาให้คนที่ทำให้โกรธ 3 นาที\nพฤหัส: ถือศีล 5 เต็มวัน ไม่พูดคำร้อน\nศุกร์: ธรรมทาน — แชร์ความรู้ 1 เรื่องให้คนที่ต้องการ\nเสาร์: นั่งสมาธิ 10 นาที + นอนก่อน 4 ทุ่ม\nอาทิตย์: เขียน 3 สิ่งที่ขอบคุณ + แผ่เมตตาทั่วทุกทิศ'
    },
    'น้ำ': {
      title: '💧 เหตุเสริมสำหรับธาตุน้ำ',
      subtitle: 'เปลี่ยนความอ่อนไหวเป็นความเข้าใจ',
      steps: [
        { icon: '🍚', name: 'ทาน — ให้อาหารคนชรา/เด็ก', action: 'ซื้ออาหารหรือขนมให้คนชราที่นั่งคนเดียว หรือเด็กที่ต้องการความอบอุ่น — ธาตุน้ำหล่อเลี้ยงชีวิต', why: 'ให้อาหาร = ปัจจัย 4 อานิสงส์สูง ให้คนชรา/เด็ก = เนื้อนาบุญดี', level: 'อามิสทาน · เนื้อนาบุญปุถุชนผู้มีศีล' },
        { icon: '🙏', name: 'ศีล 5 + งดนินทา 7 วัน', action: 'ถือศีล 5 ทุกวัน — แล้วเพิ่ม "งดนินทา" 7 วันติด ไม่ว่าใครจะน่าโมโหแค่ไหน', why: 'น้ำนิ่ง = ใจนิ่ง งดนินทา 7 วัน = ศีลข้อ 4 เข้มข้น ลดกรรมทางวาจา', level: 'ศีล 5 ทุกวัน + ศีลเพิ่ม 7 วัน' },
        { icon: '💛', name: 'เมตตา — แผ่ให้ตัวเองก่อน', action: 'ก่อนนอนคืนนี้ หลับตา 3 นาที แล้วสวด: "นิททุกโข โหมิ — ขอให้ข้าพเจ้าปราศจากทุกข์ / อัพยาปัชโฌ โหมิ — ปราศจากความเบียดเบียน"', why: 'คนธาตุน้ำรับอารมณ์คนอื่นมาเยอะ — ต้องแผ่เมตตาให้ตัวเองก่อน จึงจะมีแรงให้คนอื่น', level: 'เมตตาภาวนา · เริ่มจากตัวเอง → คนที่รัก → กลาง → ศัตรู → ทั่วทุกทิศ' },
      ...
      weekChallenge: '🎯 แบบฝึก 7 วันธาตุน้ำ:\nจันทร์: ให้เวลาคนที่ต้องการคนรับฟัง 15 นาที แค่ฟังไม่ต้องแก้\nอังคาร: แผ่เมตตาให้ตัวเอง 3 นาทีก่อนนอน\nพุธ: งดนินทาวันแรก — ถ้าเผลอ หยุดแล้วเปลี่ยนเรื่อง\nพฤหัส: ถือศีล 5 เต็มวัน + เขียน "วันนี้ปล่อยวางอะไรได้ 1 อย่าง"\nศุกร์: ให้อาหาร/ขนมคนชราหรือเด็ก 1 คน\nเสาร์: นั่งสมาธิ 5 นาที กำหนดลมหายใจ\nอาทิตย์: แผ่เมตตาทั่วทุกทิศ + เขียนขอบคุณ 3 สิ่ง'
    },
    'ลม': {
      title: '💨 เหตุเสริมสำหรับธาตุลม',
      subtitle: 'เปลี่ยนความคิดกระจายเป็นปัญญาคมชัด',
      steps: [
        { icon: '🍚', name: 'ทาน — ธรรมทาน', action: 'สอนความรู้ 1 เรื่องให้คนที่ต้องการ ฟรี ไม่หวังผลตอบแทน — ธรรมทานชนะทานทั้งปวง (สพฺพทานํ ธมฺมทานํ ชินาติ)', why: 'ธรรมทาน = ให้ปัญญา เป็นทานที่ไม่เสื่อม ให้ได้ทุกที่ทุกเวลา', level: 'ธรรมทาน · อานิสงส์สูงกว่าอามิสทาน 100 เท่า' },
        { icon: '🙏', name: 'ศีล 5 + นั่งสมาธิทุกวัน', action: 'ถือศีล 5 ทุกวัน — แล้วนั่งสมาธิ 5 นาทีทุกวันติดกัน 7 วัน วันพระถัดไป ' + nextWanPhra.dateStr + ' ถือศีล 8', why: 'ลมนิ่ง = จิตนิ่ง สมาธิช่วยรวมจิตที่กระจาย ศีล 8 วันพระ = อานิสงส์ 100 เท่า', level: 'ศีล 5 ทุกวัน + สมาธิ 5 นาที/วัน + ศีล 8 วันพระ' },
        ...
        { icon: '🧠', name: 'ปัญญา — นั่งนิ่ง 3 นาที', action: 'นั่งนิ่ง 3 นาที ดูลมหายใจ ไม่ต้องคิดอะไร แค่รู้ — "พุท" เข้า "โธ" ออก จิตฟุ้งก็กลับมา', why: 'อานาปานสติ = กรรมฐานพื้นฐานที่พระพุทธเจ้าสอนเอง เหมาะกับคนจิตกระจาย', level: 'ภาวนามยปัญญา · อานาปานสติ' }
      ],
      weekChallenge: '🎯 แบบฝึก 7 วันธาตุลม:\nจันทร์: สอนความรู้ 1 เรื่องให้คนที่ต้องการ (ธรรมทาน)\nอังคาร: นั่งสมาธิ 5 นาที กำหนดลมหายใจ\nพุธ: ก่อนพูดทุกครั้ง เว้น 1 ลมหายใจ\nพฤหัส: ถือศีล 5 เต็มวัน + นั่งสมาธิ 5 นาที\nศุกร์: เลือก 1 เป้าหมาย ทำให้คืบหน้า ปิดสิ่งรบกวน 45 นาที\nเสาร์: แผ่เมตตาให้คนที่ขัดใจ 3 นาที\nอาทิตย์: นั่งสมาธิ 10 นาที + เขียนขอบคุณ 3 สิ่ง'
    },
    'ดิน': {
      title: '🪨 เหตุเสริมสำหรับธาตุดิน',
      subtitle: 'เปลี่ยนความแข็งแกร่งเป็นความยืดหยุ่น',
      steps: [
        { icon: '🍚', name: 'ทาน — ให้แรงกาย', action: 'ช่วยคนย้ายของ ทำความสะอาดวัด หรือช่วยงานจิตอาสา 1 อย่าง — ธาตุดินให้แรงกาย = ทานที่ใช้ร่างกายเป็นเครื่องมือ', why: 'แรงกายทาน = ใช้ร่างกายเป็นทาน ได้อานิสงส์ทั้งกายและใจ', level: 'อามิสทาน (แรงกาย) · เนื้อนาบุญวัด/ชุมชน' },
        { icon: '🙏', name: 'ศีล 5 + ตื่นเช้า 7 วัน', action: 'ถือศีล 5 ทุกวัน — แล้วตื่นก่อน 6 โมงเช้า 7 วันติด วันพระถัดไป ' + nextWanPhra.dateStr + ' ถือศีล 8', why: 'ดินมั่นคง = วินัย ตื่นเช้า = สร้างความสม่ำเสมอ ศีล 8 วันพระ = อานิสงส์ 100 เท่า', level: 'ศีล 5 ทุกวัน + วินัย 7 วัน + ศีล 8 วันพระ' },
        ...
        { icon: '🧠', name: 'ปัญญา — เดินจงกรม 10 นาที', action: 'เดินช้าๆ รู้สึกเท้าแตะพื้น ทีละก้าว 10 นาที — ไม่คิดเรื่องงาน แค่รู้ว่าเดิน', why: 'เดินจงกรม = กรรมฐาน 4 อิริยาบถ หลวงปู่ชาสอน: "เดินก็รู้ว่าเดิน" — เหมาะกับคนธาตุดินที่นั่งนิ่งยาก', level: 'ภาวนามยปัญญา · กรรมฐาน 4 อิริยาบถ' }
      ],
      weekChallenge: '🎯 แบบฝึก 7 วันธาตุดิน:\nจันทร์: มอบหมายงาน 1 อย่างที่เคยแบกคนเดียว\nอังคาร: ตื่นก่อน 6 โมงเช้า + แผ่เมตตาให้ตัวเอง 3 นาที\nพุธ: ช่วยคนย้ายของหรือทำความสะอาด 1 อย่าง (ทานแรงกาย)\nพฤหัส: ถือศีล 5 เต็มวัน + ชม/ขอบคุณคนใกล้ตัว 1 คน\nศุกร์: เดินจงกรม 10 นาที รู้สึกเท้าแตะพื้น\nเสาร์: นั่งสมาธิ 5 นาที กำหนดลมหายใจ\nอาทิตย์: แผ่เมตตาทั่วทุกทิศ + เขียนขอบคุณ 3 สิ่ง'
    }
  };
